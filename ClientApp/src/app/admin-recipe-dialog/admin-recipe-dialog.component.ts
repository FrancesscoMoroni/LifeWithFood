...
export class AdminRecipeDialogComponent {
  ...
  constructor(private fb: FormBuilder, public dialog: MatDialog, public dialogRef: MatDialogRef<AdminRecipeDialogComponent>, @Inject(MAT_DIALOG_DATA) public data: DialogData, private adminDataService: AdminDataService) {
    if (data.mode) {
